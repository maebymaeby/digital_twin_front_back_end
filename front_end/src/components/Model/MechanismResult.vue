<template>
  <el-row class="mechanismresult_framework" v-if="isDecay"></el-row>
  <el-row class="mechanismresult_framework" v-else>
    <!-- 模型操作按钮区域 -->
        ...
        this.requestData = Object.assign(
          {
            ...
            best_str: this.modelResult.bestStr,
          },
          this.modelInfo);
        return new Promise((resolve, reject) => {
          STORE
            .dispatch("Model/saveMechanismModel", this.requestData)
            .then((res) => {
