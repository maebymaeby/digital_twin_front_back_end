  ...
  export default {
    ...
    methods: {
      ...
      sendFilterData() {
        ...
        return new Promise((resolve, reject) => {
          STORE
            .dispatch("Admin/getModelListByFilter", this.filterData)
            .then((res) => {
              this.tableData = this.processModelListData(res.data.data);
              resolve(res);
            })
...
<style>
  .modelmanagement_framework_usering {
    height: 600px;
    margin: 16px;
    padding: 24px;
